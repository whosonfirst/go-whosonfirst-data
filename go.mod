module github.com/whosonfirst/go-whosonfirst-data
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-findingaid/v2 v2.8.6
	github.com/whosonfirst/go-whosonfirst-uri v1.3.0
)

require (
	github.com/aaronland/go-aws-dynamodb v0.0.7 // indirect
